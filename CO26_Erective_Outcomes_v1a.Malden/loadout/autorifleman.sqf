...
_mag = "";
switch (_gun) do {
	case "UK3CB_RPK_74N_PLUM": {
		_mag = "rhs_45Rnd_545X39_7N10_AK";
	};
	case "UK3CB_RPK_74N": {
		_mag = "rhs_45Rnd_545X39_7N10_AK";
	};
	...
	case default {
		_mag = "rhs_45Rnd_545X39_7N10_AK"; // default - 5.45x39
	};
};
...
{_unit addItem _mag} count [1];
_unit addWeapon _gun;
{_unit addItemToVest _mag} count [1,2,3,4];
...
{_unit addItemToBackpack _pistolMag} count [1,2];
{_unit addItemToBackpack _mag} count [1,2,3,4,5];
