...
{_unit addItemToVest _mag} count [1,2,3,4,5,6,7];
...
{_unit addItemToBackpack "SmokeShell"} count [1];
...
{_unit addItemToBackpack "rhs_rpg7_PG7VL_mag"} count [1,2];
{_unit addItemToBackpack _mag} count [1,2,3];
