...
//_garrisonUnits = ["rhsgref_tla_g_squadleader","rhsgref_tla_g_machinegunner","rhsgref_tla_g_rifleman_vz58","rhsgref_tla_g_specialist_at","rhsgref_tla_g_rifleman","rhsgref_tla_g_rifleman","rhsgref_tla_g_rifleman_vz58","rhsgref_tla_g_rifleman_vz58","rhsgref_tla_g_rifleman","rhsgref_tla_g_rifleman","rhsgref_tla_g_rifleman_akms","rhsgref_tla_g_rifleman_akms"]; // Large 12 man group (Town garrison)

// Additional group size parameter presets
//_garrisonUnits2 = ["rhsgref_tla_g_squadleader","rhsgref_tla_g_machinegunner","rhsgref_tla_g_rifleman_vz58","rhsgref_tla_g_specialist_at","rhsgref_tla_g_rifleman","rhsgref_tla_g_rifleman","rhsgref_tla_g_rifleman","rhsgref_tla_g_rifleman_akms"]; // 8 man mixed group
//_garrisonUnits3 = ["rhsgref_tla_g_squadleader","rhsgref_tla_g_machinegunner","rhsgref_tla_g_specialist_at","rhsgref_tla_g_rifleman","rhsgref_tla_g_rifleman_akms","rhsgref_tla_g_rifleman_vz58"]; // 6 Mixed units
...
_garrisonUnits2 = [ // 10 Units mixed
	"rhsgref_ins_squadleader",
	"rhsgref_ins_grenadier_rpg",
	"rhsgref_ins_rifleman_rpg26",
	"rhsgref_ins_machinegunner",
...
_garrisonUnits7 = [ // objective Russian team
