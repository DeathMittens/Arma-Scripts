	...
	while {_run > 0} do
	{
		switch (_run) do
		{
			...
			case 9:	{
						...
						if (DAC_Marker > 0 && {(DAC_Marker_Val select 3) > 0}) then {[_leaderman,1,_group] execVM "DAC\Marker\DAC_GroupMarker.sqf"};
