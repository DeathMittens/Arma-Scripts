...
while{_status == 0} do
{
	...
	_text2 = "<t color='#CCCCCC' size='0.7' shadow='1' shadowColor='#333333' font='Zeppelin32'><br/>";
	_text3 = "<t color='#FFFF99' size='0.7' shadow='0' font='Zeppelin32' align='left'>";
...
if(_status == 3) then
{
	call compile ((DAC_Sector_Values select 4) select 2);
}
else
{
	call compile ((DAC_Sector_Values select 5) select 2);
};