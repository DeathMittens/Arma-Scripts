...
private	[
			...
			"_temp","_insert","_newID","_check","_wpTemp","_ZV","_h","_zData","_g","_wpVal"
		];

_array = _this select 0;_val = ((_this select 1) - 1);_i = 0;_sum = 0;_e = [];_c = 0;_temp = [];_insert = false;_newID = 0;_check = [];
_wpString = _array select 0;_wpNumeric = _array select 1;_zones = _array select 2;_ZV = false;_h = 0;_zData = [];_g = 0;_wpVal = [];
