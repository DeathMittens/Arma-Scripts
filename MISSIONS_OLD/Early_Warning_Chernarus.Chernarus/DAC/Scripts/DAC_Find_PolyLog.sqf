...
private ["_zone","_tempList","_posArray","_log","_checkwp","_wn","_action","_dist","_wn"];
		
_zone = _this select 0;_posArray = [];_log = objNull;_checkwp = [];_wn = 1;_action = true;_dist = 100000;_wn = 1;
...
{
	{
		...
		{
			if(!isNil {_x getVariable "Link"}) then
			{
