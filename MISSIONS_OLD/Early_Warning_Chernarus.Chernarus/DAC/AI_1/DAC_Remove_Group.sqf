...
_groupA = _this select 0;_para = _this select 1;_typ = _this select 2;_s = -1;_dummy = objNull;
_sidearray = ["E","W","R","C"];_sideunit = ["EAST","WEST","GUER","CIV"];_unit = ((units _groupA) select 0);
_temp = ["DAC_All_Groups","DAC_Help_Groups","DAC_Fire_Groups","DAC_Radio_Groups","DAC_Cover_Groups","DAC_Call_Groups","DAC_Hit_Groups","DAC_No_Support","DAC_Min_Groups","DAC_Arti_Array"];
...
switch (_typ) do
{
	...
	case 1:	{
				...
				sleep 0.1;
				_dummy = _groupA createUnit ["B_Soldier_SL_F",[100,100,0],[], 0, "NONE"];
				{
