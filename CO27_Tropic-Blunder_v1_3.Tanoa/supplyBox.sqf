...
_crate addMagazineCargoGlobal ["rhs_mag_30Rnd_556x45_M855A1_Stanag", 40];
...
_crate addItemCargoGlobal ["ACE_NVG_Gen4", 8];

_crate addItemCargoGlobal ["rhsusf_acc_anpeq15side_bk", 8];
_crate addItemCargoGlobal ["rhsusf_acc_compm4", 8];
_crate addItemCargoGlobal ["rhsusf_acc_anpeq15", 8];
_crate addItemCargoGlobal ["rhsusf_acc_eotech_xps3", 8];
