...
/*
vh1 setVariable ["TF_RadioType", "TF_anprc155", true];
vh2 setVariable ["TF_RadioType", "TF_anprc155", true];
vh3 setVariable ["TF_RadioType", "TF_anprc155", true];
vh4 setVariable ["TF_RadioType", "TF_anprc155", true];
*/
